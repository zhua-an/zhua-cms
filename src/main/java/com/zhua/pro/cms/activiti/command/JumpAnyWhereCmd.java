package com.zhua.pro.cms.activiti.command;
...
public class JumpAnyWhereCmd implements Command<Void> {
    ...
    private final RepositoryService repositoryService = SpringContextConfig.getBean(RepositoryService.class);
...
//        Process process = ProcessDefinitionUtil.getProcess(processDefinitionId);
        ...
        commentEntity.setUserId(this.assignee);
        ...
        // 删除正在执行的当前任务
//        taskEntityManager.delete(this.taskId);//报外键错误
        taskEntityManager.deleteTask(currentTask, this.comment, false, false);
